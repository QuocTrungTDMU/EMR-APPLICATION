(function () {
  ...
  if (selectedLanguage && dropdown) {
    ...
    dropdown.addEventListener("click", (event) => {
      ...
      selectedLanguage.querySelector(
        ".selected-language span:last-child"
      ).textContent = name;
      ...
      parent.addEventListener("click", () => {
        ...
        if (dropdown) {
          ...
          if (!item.classList.contains("active")) {
            ...
            currentDropdown.style.maxHeight =
              currentDropdown.scrollHeight + "px"; // Set max-height based on actual content height
          } else {
