            ...
            (this.endVal = t),
              ...
              (this.formatNumber = function (e) {
                var t,
                  n,
                  r,
                  o = (Math.abs(e).toFixed(i.options.decimalPlaces) + "").split(
                    "."
                  );
                if (
                  ((t = o[0]),
                  ...
                  r = "";
                  for (var a = 3, s = 0, l = 0, c = t.length; l < c; ++l)
                    i.options.useIndianSeparators &&
                      4 === l &&
                      ((a = 2), (s = 1)),
                      0 !== l && s % a == 0 && (r = i.options.separator + r),
                      s++,
                      (r = t[c - l - 1] + r);
                  t = r;
                }
      ...
      var f = function (e, t) {
        ...
        y = function (e) {
          var t = Object.fromEntries(
            ...
            k = r.useRef(!1),
            E = d(function () {
              return f("string" == typeof i ? i : i.current, S);
            }),
            j = d(function (e) {
              var t = w.current;
              if (t && !e) return t;
            ...
            P = d(function () {
              var e = function () {
                return j(!0).start(function () {
                  null == y ||
                    y({ pauseResume: T, reset: _, start: C, update: x });
                });
              };
              u && u > 0 ? (O.current = setTimeout(e, 1e3 * u)) : e(),
                null == v || v({ pauseResume: T, reset: _, update: x });
            }),
            T = d(function () {
              j().pauseResume(),
                null == b || b({ reset: _, start: C, update: x });
            }),
            _ = d(function () {
              j().el &&
                (O.current && clearTimeout(O.current),
                j().reset(),
                null == g || g({ pauseResume: T, start: C, update: x }));
            }),
            x = d(function (e) {
              j().update(e),
                null == m || m({ pauseResume: T, reset: _, start: C });
            }),
            C = d(function () {
              _(), P();
            }),
          ...
          return (
            ...
            { start: C, pauseResume: T, reset: _, update: x, getCountUp: j }
          );
        },
      ...
      (t.canGoNext = b),
        ...
        (t.slideHandler = function (e) {
          ...
          if (r) {
            ...
            (g = w),
              ...
              !i && w + h >= l && (g = l - h),
              (m = E(a(a({}, e), {}, { slideIndex: w }))),
              (S = E(a(a({}, e), {}, { slideIndex: g }))),
              i || (m === S && (w = g), (m = S)),
        ...
        (t.swipeMove = function (e, t) {
          ...
          if (!n) {
            ...
            if (!s && !y && C > 10) return { scrolling: !0 };
            s && (w.swipeLength = C);
            var M = (c ? -1 : 1) * (w.curX > w.startX ? 1 : -1);
            s && (M = w.curY > w.startY ? 1 : -1);
            var L = v(t.touchObject, s),
              R = w.swipeLength;
            return (
              !S &&
                ((0 === u && ("right" === L || "down" === L)) ||
                  (u + 1 >= Math.ceil(g / m) && ("left" === L || "up" === L)) ||
                  (!b(t) && ("left" === L || "up" === L))) &&
                ((R = w.swipeLength * d),
                !1 === f && p && (p(L), (_.edgeDragged = !0))),
              !h && k && (k(L), (_.swiped = !0)),
              (T = i ? x + R * (j / P) * M : c ? x - R * M : x + R * M),
              s && (T = x + R * M),
              (_ = a(
                a({}, _),
                {},
                {
                  touchObject: w,
                  swipeLeft: T,
                  trackStyle: O(a(a({}, t), {}, { left: T })),
                }
              )),
              Math.abs(w.curX - w.startX) < 0.8 * Math.abs(w.curY - w.startY) ||
                (w.swipeLength > 10 && ((_.swiping = !0), l(e))),
              _
            );
          }
        }),
        (t.swipeEnd = function (e, t) {
          ...
          if (i.swipeLength > (c ? u / s : o / s)) {
            ...
            switch (g) {
              case "left":
              case "up":
                (j = P + S(t)), (O = d ? m(t, j) : j), (w.currentDirection = 0);
                break;
              case "right":
              case "down":
                (j = P - S(t)), (O = d ? m(t, j) : j), (w.currentDirection = 1);
                break;
              default:
                O = P;
            }
      ...
      var E = function (e) {
        ...
        if (
          ...
          if (
            ...
            (m = r ? t + j(e) : t), (g = S && S.children[m]), (b = 0);
            for (var O = 0; O < m; O++)
