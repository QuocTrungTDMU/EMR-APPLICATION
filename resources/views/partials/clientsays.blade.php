    ...
    <div class="relative w-full flex justify-center mt-12" data-aos="fade-in">
        <div class="w-full max-w-3xl px-2">
            <div class="swiper mySwiper">
                ...
                <!-- Navigation buttons -->
                <div class="swiper-button-prev !left-4 !top-1/2 !-translate-y-1/2 !w-10 !h-10 !bg-blue-600 hover:!bg-blue-700 !text-white !rounded-lg !shadow-xl !flex !items-center !justify-center !transition-all !duration-200 after:!content-['']">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M15 19l-7-7 7-7" />
                    </svg>
                </div>

                <div class="swiper-button-next !right-4 !top-1/2 !-translate-y-1/2 !w-10 !h-10 !bg-blue-600 hover:!bg-blue-700 !text-white !rounded-lg !shadow-xl !flex !items-center !justify-center !transition-all !duration-200 after:!content-['']">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
