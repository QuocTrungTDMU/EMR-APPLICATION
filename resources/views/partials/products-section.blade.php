    ...
    <div class="max-w-7xl mx-auto flex flex-col items-center">
        ...
        <div class="w-full">
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2">
                ...
                <!-- Product Card -->
                <div class="product-card group bg-white rounded-xl sm:rounded-2xl border-2 border-blue-200 hover:border-blue-400 transition-all duration-300 flex flex-col relative overflow-hidden min-h-[300px] sm:min-h-[320px] lg:min-h-[380px] shadow-lg hover:shadow-xl mx-4 sm:mx-0">
