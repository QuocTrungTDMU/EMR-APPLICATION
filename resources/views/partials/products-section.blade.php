...
<section class="w-full bg-white py-10">
    <div class="max-w-7xl mx-auto flex flex-col items-center">
        ...
        <!-- Products Grid với 4 cột thay vì 6 cột -->
        <div class="w-full">
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">

                <!-- Product Card - Phiên bản TO HẠ -->
                <div class="product-card group bg-white rounded-2xl border-2 border-blue-200 hover:border-blue-400 transition-all duration-300 flex flex-col items-center py-8 px-6 relative overflow-hidden min-h-[420px] shadow-lg hover:shadow-xl">
                    <!-- Product Image Container -->
                    <div class="relative w-full h-52 mb-6 flex items-center justify-center bg-gray-50 rounded-xl">
                        <img src="https://medik.wpenginepowered.com/wp-content/uploads/2019/01/5-15-1000x1000.jpg" alt="Vitamin C Tablet" class="h-48 object-contain">
                    ...
                    <div class="font-bold text-xl mb-4 text-center text-gray-800">Vitamin C Tablet</div>
                    ...
                    <div class="font-semibold text-blue-600 text-2xl mb-6">₹60.00</div>

                    <!-- Button -->
                    <button class="add-to-cart-btn bg-cyan-400 hover:bg-cyan-500 text-white font-bold rounded-full px-8 py-3 transition-all duration-300 flex items-center justify-center min-w-[170px] text-lg shadow-lg hover:shadow-xl">
                        <span class="add-text">ADD TO CART</span>
                        <svg class="cart-icon w-7 h-7 hidden" fill="currentColor" viewBox="0 0 20 20">
