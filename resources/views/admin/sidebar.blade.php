    ...
    <nav x-data="{selected: $persist('Dashboard')}">
      ...
      <div>
        ...
        <ul class="mb-6 flex flex-col gap-4">
          ...
          <li>
    <a
      href="{{ route('admin.patients.index') }}" <!-- Sử dụng route Laravel -->
      @click="selected = (selected === 'Patients' ? '' : 'Patients')" <!-- Đổi tên từ 'Calendar' thành 'Patients' -->
      class="menu-item group"
      :class="(selected === 'Patients') && (page === 'patients') ? 'menu-item-active' : 'menu-item-inactive'">
      <svg
      ...
      <span
        class="menu-item-text"
        :class="sidebarToggle ? 'lg:hidden' : ''">
        Patients <!-- Đổi tên từ 'Calendar' thành 'Patients' -->
      </span>
    </a>
</li>
          <!-- Menu Item Calendar -->
