...
<head>
    ...
    <title>Đăng nhập | NKS System - Hệ thống quản lý y tế</title>
...
<body class="font-sans antialiased" id="body">
    <div class="relative p-6 bg-white z-10 dark:bg-gray-900 sm:p-0" id="pageWrapper">
        <div class="relative flex flex-col justify-center w-full h-screen dark:bg-gray-900 sm:p-0 lg:flex-row">

            <!-- Form Section -->
            <div class="flex flex-col flex-1 w-full lg:w-1/2">
                <div class="w-full max-w-md pt-10 mx-auto">
                    <a href="{{ route('homepage') }}" class="inline-flex items-center text-sm text-gray-500 transition-colors hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300">
                ...
                <div class="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
                    <div>
                        ...
                        <div class="mb-5 sm:mb-8">
                            <h1 class="mb-2 font-semibold text-gray-800 text-3xl dark:text-white/90 sm:text-4xl">
                                Đăng nhập
                            </h1>
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                Nhập email và mật khẩu để đăng nhập qua hệ thống NKS!
                            </p>
                        </div>
                        ...
                        <div class="mb-4 p-4 bg-red-50 border border-red-200 rounded-lg dark:bg-red-900/20 dark:border-red-800">
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    <h3 class="text-sm font-medium text-red-800 dark:text-red-200">Có lỗi xảy ra:</h3>
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <span id="passwordToggle" class="absolute z-30 text-gray-500 -translate-y-1/2 cursor-pointer right-4 top-1/2 dark:text-gray-400 password-toggle">
                                                <svg id="eyeOpen" class="fill-current" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <svg id="eyeClosed" class="fill-current hidden" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- Right Side Brand -->
            <div class="relative items-center hidden w-full h-full bg-blue-950 dark:bg-white/5 lg:grid lg:w-1/2">
                <div class="flex items-center justify-center z-10">
                    <div class="absolute inset-0 opacity-20">
                        <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
                            <defs>
                                <pattern id="grid" width="40" height="40" patternUnits="userSpaceOnUse">
                                    <path d="M 40 0 L 0 0 0 40" fill="none" stroke="currentColor" stroke-width="1" opacity="0.5" />
                                </pattern>
                            </defs>
                    ...
                    <div class="flex flex-col items-center max-w-xs text-center">
                        <a href="{{ route('homepage') }}" class="block mb-4">
                        ...
                        <h2 class="text-2xl font-bold text-white mb-2">NKS System</h2>
                        <p class="text-center text-gray-300 dark:text-white/60">
                            Hệ thống quản lý y tế hiện đại và chuyên nghiệp cho các cơ sở y tế
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="fixed z-50 hidden bottom-6 right-6 sm:block">
                <button id="darkModeToggle" class="inline-flex items-center justify-center text-white transition-colors rounded-full w-14 h-14 bg-blue-500 hover:bg-blue-600 dark-mode-toggle">
                    ...
                    <svg id="moonIcon" class="fill-current" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M17.4547 11.97L18.1799 12.1611C18.265 11.8383 18.1265 11.4982 17.8401 11.3266C17.5538 11.1551 17.1885 11.1934 16.944 11.4207L17.4547 11.97ZM8.0306 2.5459L8.57989 3.05657C8.80718 2.81209 8.84554 2.44682 8.67398 2.16046C8.50243 1.8741 8.16227 1.73559 7.83948 1.82066L8.0306 2.5459ZM12.9154 13.0035C9.64678 13.0035 6.99707 10.3538 6.99707 7.08524H5.49707C5.49707 11.1823 8.81835 14.5035 12.9154 14.5035V13.0035ZM16.944 11.4207C15.8869 12.4035 14.4721 13.0035 12.9154 13.0035V14.5035C14.8657 14.5035 16.6418 13.7499 17.9654 12.5193L16.944 11.4207Z" fill="" />
                    </svg>
                </button>
            </div>
        </div>
    ...
    <script>
        ...
        function initDarkMode() {
            ...
            if (savedDarkMode) {
                ...
                pageWrapper.classList.add('dark:bg-gray-900');
